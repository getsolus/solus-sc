...
pycodestyle xng/*.py xng/plugins/*.py xng/plugins/eopkg/*.py xng/util/*.py new.py || exit 1
flake8 --builtins="_" xng/*.py xng/plugins/*.py xng/plugins/eopkg/*.py xng/util/*.py new.py || exit 1
