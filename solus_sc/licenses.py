...
def spdx_to_uri(spdx):
    """ Return the SPDX URL for a given SPDX ID """
    return "https://spdx.org/licenses/{}.html".format(spdx)


# This section must be resynced with licenses.spdx in the root
licenses = [
    "0BSD",
    "AAL",
    "Abstyles",
